...
public class LoginData implements Serializable {
    ...
    public LoginData(Integer id, String first_name, String last_name, String email, String username, String type, LoginProfile profile, String verified_at, String created_at, String updated_at) {
        this.id = id;
