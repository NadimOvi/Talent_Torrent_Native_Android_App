...
public class LoginProfile implements Serializable {
    ...
    public LoginProfile(Integer id, Integer is_public, String avatar_url, String cover_photo_url, String date_of_birth, String phone, String qualification, String experience, ArrayList<String> skills, String business_number, String cover_letter, String job_title, String company_name, String company_size, String business_type, String company_registration_number, String location, String country, String created_at, String updated_at) {
        this.id = id;
