...
public class AppliedUserModel {
    ...
    public AppliedUserModel() {
    }

    public AppliedUserModel(int id, String first_name, String last_name, String email, String username, String type, ProfileStatus profile, String verified_at, String created_at, String updated_at) {
        this.id = id;
